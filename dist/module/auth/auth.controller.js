...
router.post("/verify", auth_service_1.default.verify);
router.post("/login", (0, validation_middleware_1.isValid)(authValidation.LoginSchema), auth_service_1.default.login);
